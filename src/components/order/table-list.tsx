  ...
  const columns = [
    {
      ...
      key: 'orderNumber',
      render(orderNumber:any, record:any) {
        return <Link href={{ pathname: '/order/detail', query: { id: record._id } }}>{orderNumber}</Link>
      }
    },
    {
      title: 'User',
    ...
    },
    {
      ...
      dataIndex: '_id',
      render(id: string) {
        return <Link href={{ pathname: '/order/detail', query: { id } }}><EyeOutlined /></Link>
      }
    }
  ]
  return (
