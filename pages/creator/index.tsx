...
export default class Performers extends PureComponent<IProps> {
  ...
  async handleDelete(performer: any): Promise<void> {
    ...
    const confirmation = window.confirm(
      `Are you sure to delete ${performer?.name || performer?.username || 'this creator'
      }?`
    )
    ...
    try {
      ...
      await this.search(pagination.current || 1)
    } catch (error: any) {
